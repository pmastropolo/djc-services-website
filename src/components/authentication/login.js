                    ...
                    <Tabs defaultActiveKey="Email" id="uncontrolled-tab-example" className="tab-content">
                      <Tab eventKey="Email" title="Email" className='p-0 pt-5'>
                          ...
                          <div className="text-end pt-4">
                            <p className="mb-0 fs-13"><Link href={`/components/authentication/forgot-password`} className="text-primary ms-1">Forgot Password?</Link></p>
                          </div>
                          ...
                          <div className="text-center pt-3">
                            <p className="text-dark mb-0 fs-13 mx-3">Not a member?<Link href={`/components/authentication/register`} className="text-primary ms-1">Sign UP</Link></p>
                          </div>
                      ...
                      <Tab eventKey="Mobile" title="Mobile">
                        <div className="tab-pane pt-5" id="tab6">
                          ...
                          <span className="fw-normal fs-13">Note : Login with registered mobile number to generate OTP.</span>
                          <div className="container-login100-form-btn ">
